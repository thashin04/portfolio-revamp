        ...
        classNameNotInView="opacity-0 translate-y-10"
            ...
            <div className="flex flex-col py-12 justify-center items-center lg:flex-row lg:w-3/4 mx-auto mt-8 gap-8">
                ...
                <div className="text-cream lg:px-12 sm:px-8 space-y-0 max-sm:space-y-2 flex flex-col lg:items-start pt-0">
                    ...
                    I am a junior Information Technology Major with a minor in Digital Media at the University of Central Florida. I am always learning to find new ideas to bring accessibility to others. I am a <span className='font-bold'>UI/UX intern and Web Developer</span> at <a href="https://limbitless-solutions.org/" target="blank" className="dark:text-sage text-matcha font-bold wavy-decoration"> Limbitless Solutions</a> and a <span className='font-bold'>Web Developer</span> for CDL <a href="https://techrangers.cdl.ucf.edu/" target="blank" className="dark:text-sage font-bold text-matcha wavy-decoration"> Techrangers.</a> In my free time, I like to draw, cook, go to new cafes, and play Stardew Valley!
                    </p>
                    <br />
