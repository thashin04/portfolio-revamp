  ...
  return (
    <div className="flex flex-col py-12 justify-center items-center lg:flex-row lg:w-3/4 mx-auto mt-8 gap-8">
      ...
      <div className="text-cream lg:px-12 sm:px-8 space-y-0 max-sm:space-y-2 flex flex-col lg:items-start pt-0">
            <h1 className="max-sm:text-4xl md:pb-4 font-Bebas_Neue text-center lg:text-left text-5xl 2xl:text-6x dark:text-sage text-matcha">ABOUT ME</h1>
              <p className="max-md:mx-12 font-IBM_Plex_Mono leading-relaxed dark:text-cream text-darkbrown xl:max-w-2xl max-xl:max-w-sm text-left 2xl:text-3xl"> 
            ...
            <br />
            <h3 className="font-Albert_Sans font-italic text-xl max-md:mx-12 max-w-md 2xl:text-2xl dark:text-sage text-matcha text-left">
              CONTACT ME!
              </h3>
              <div className="flex max-md:px-12 gap-3">
                <a href="/resume.pdf" target="_blank" className="cursor-pointer btn-2">
                  <svg
                    className="p-2 rounded-lg fill-current dark:text-cream dark:hover:text-tan text-darkbrown hover:text-matcha transition-colors duration-300"
